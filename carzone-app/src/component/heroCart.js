...
function HeroCart() {
    return (
       <>
        ...
        <Typography color="text.primary"> <h5 className="text-dark">Cart</h5></Typography>
      </Breadcrumbs>
        </div>
        ...
        <div class="seoLanding deliveryLanding redesign mb-4">
            <header class="banner">
                ...
                <div class="headerImgWrap">
                    <img class="headerImg1" src="https://static1.cargurus.com/gfx/delivery/hero-delivery.svg" role="presentation" alt="" width="841" height="341" />
                </div>
            </header>
